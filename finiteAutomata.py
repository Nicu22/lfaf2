...
The display method takes in the finite state machine self as an argument, which is an object that has F (a set of final states) 
and delta (a list of transitions between states) as attributes.
